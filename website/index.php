...
<head>
    ...
    <!-- <script defer onload="attach_rapid_web_analytics('68abea027874c')" src="https://apps.edward-blewitt.uk/resources/web-analytics/analytics_v1.0.js"></script> -->
    ...
    <header x-data="{ menuOpen: false }">
        ...
        <div class="flex gap-m">
            ...
            <div class="header-nav" :class="menuOpen ? 'open' : ''">
                ...
                <a class="header-link" href="/contact" @click="menuOpen = false">Contact</a>
                ...
                <a href="https://app.exetertracker.com" @click="menuOpen = false">
                    <button class="go-to-tracker">
                        <span>Go to tracker</span>
                        <img class="icon" src="/resources/images/icons/external.svg" alt="Exterior link icon">
                    </button>
